...
var switchNode = require('@node-red/core/function/10-switch');
var changeNode = require('@node-red/core/function/15-change');
var rangeNode = require('@node-red/core/function/16-range');
var templateNode = require('@node-red/core/function/80-template');
var delayNode = require('@node-red/core/function/89-delay');
var triggerNode = require('@node-red/nodes/core/function/89-trigger');
var execNode = require('@node-red/nodes/core/function/90-exec');
var rbeNode = require('@node-red/nodes/core/function/rbe');
var injectNode = require('@node-red/nodes/core/common/20-inject');
var debugNode = require('@node-red/nodes/core/common/21-debug');
var completeNode = require('@node-red/nodes/core/common/24-complete');
var catchNode = require('@node-red/nodes/core/common/25-catch');
var statusNode = require('@node-red/nodes/core/common/25-status');
var linkNode = require('@node-red/nodes/core/common/60-link');
var commentNode = require('@node-red/nodes/core/common/90-comment');
var unknownNode = require('@node-red/nodes/core/common/98-unknown');
var tlsNode = require('@node-red/nodes/core/network/05-tls');
var httpproxyNode = require('@node-red/nodes/core/network/06-httpproxy');
var mqttNode = require('@node-red/nodes/core/network/10-mqtt');
var httpinNode = require('@node-red/nodes/core/network/21-httpin');
var httprequestNode = require('@node-red/nodes/core/network/21-httprequest');
var websocketNode = require('@node-red/nodes/core/network/22-websocket');
var tcpinNode = require('@node-red/nodes/core/network/31-tcpin');
var udpNode = require('@node-red/nodes/core/network/32-udp');
var csvNode = require('@node-red/nodes/core/parsers/70-CSV');
var htmlNode = require('@node-red/nodes/core/parsers/70-HTML');
var jsonNode = require('@node-red/nodes/core/parsers/70-JSON');
var xmlNode = require('@node-red/nodes/core/parsers/70-XML');
var yamlNode = require('@node-red/nodes/core/parsers/70-YAML');
var splitNode = require('@node-red/nodes/core/sequence/17-split');
var sortNode = require('@node-red/nodes/core/sequence/18-sort');
